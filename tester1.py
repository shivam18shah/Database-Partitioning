...
if __name__ == '__main__':
    ...
    try:
        ...
        with testHelper.getOpenConnection(dbname=DATABASE_NAME) as conn:
            ...
            if result :
                print("range partition function pass!")
            ...
            if result:
                print("range insert function pass!")
            ...
            # check for the number of rows and how the next row will be assigned before changing this set of tests
            ...
            # [result, e] = testHelper.testroundrobininsert(MyAssignment, RATINGS_TABLE, 600, 1, 3, conn, '3')
